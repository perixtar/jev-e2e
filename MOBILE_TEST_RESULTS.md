...
The complete, sanitized [60-suite / 300-case first-attempt record](docs/benchmarks/native-mobile-2026-09-19.json) includes each trial's baseline, verdict, checked counts, timings, requests, model, and billed API cost. No trials were retried, omitted, or replaced after seeing the result.
